pipeline {
    ...
    environment {
        GITHUB_URL = 'https://github.com/miamioh-allame/metallb-deploy.git'  // <---- Change this to match your cloned repository
        KUBECONFIG = credentials('allame-225')   // <---- Change this to match your kubernetes cluster credentials
    }
